class Solution:
    def longestCommonSubsequence(self, text1: str, text2: str) -> int:
        ...
        # within each call, you find the 
        # if you run out of text2 then just return currSum
        # if not, then add to currSum and call recursively again
        # base case: i == len(text1) or j == len(text2), return 0
